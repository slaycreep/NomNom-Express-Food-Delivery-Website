...
<body>
    ...
    <table border="1">
        ...
        $sql = "SELECT o.order_id, o.restaurant_id, o1.order_location FROM orderinfo o, orderhistory o1 WHERE o.order_id=o1.order_id AND o.rider_id= ? AND o1.order_status='ongoing' "; // Update your query
    ...
    <h2>Are you done delivering?</h2>
    <section id = "section1">

		<form action="delivered.php" class="form_design" method="post">
            Enter Delivered Order ID: <input type="text" name="order_id"> <br/>
